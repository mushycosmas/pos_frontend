...
const Sidebar = () => {
  ...
  // ============================================================
  //
  // `permission` controls whether the menu item is displayed.
  //
  // IMPORTANT:
    ...
    // ==========================================================
    {
      ...
      items: [
        ...
        },
        {
          ...
          icon: 'bi-truck',
          path: '/suppliers',
          permission: 'suppliers.view_supplier',
        },
        {
    ...
    // ==========================================================
    {
      ...
      items: [
        ...
        },
        {
          ...
          permission: 'cash_management.view_cash',
        },
      ],
    },
    ...
    // ==========================================================
    {
      ...
      items: [
        ...
        },
        {
          ...
          permission: 'reports.view_expense_report',
        },
        {
          name: 'Profit & Loss',
